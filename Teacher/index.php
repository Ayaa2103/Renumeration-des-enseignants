...
<head>
	...
	<title>Enseignant -Acceuil-</title>
    ...
    <div class="container mt-5">
         ...
         <div class="card" style="width: 20rem;">
          ...
          <ul class="list-group list-group-flush">
            <li class="list-group-item">Prenom: <?=$teacher['fname']?></li>
            <li class="list-group-item">Nom: <?=$teacher['lname']?></li>
            <li class="list-group-item">Nom d'utilisateur: <?=$teacher['username']?></li>

            <li class="list-group-item">Numero ID: <?=$teacher['employee_number']?></li>
            <li class="list-group-item">Adresse: <?=$teacher['address']?></li>
            <li class="list-group-item">Date de naissance: <?=$teacher['date_of_birth']?></li>
            <li class="list-group-item">Numero de telephone: <?=$teacher['phone_number']?></li>
            <li class="list-group-item">Niveau d'etudes: <?=$teacher['qualification']?></li>
            <li class="list-group-item">Adresse Email: <?=$teacher['email_address']?></li>
            <li class="list-group-item">Genre: <?=$teacher['gender']?></li>
            <li class="list-group-item">Date d'adhesion: <?=$teacher['date_of_joined']?></li>
